...
class ConfigStore(context: Context) {
    ...
    val geoVisionUrl: String get() = prefs.getString(PREF_BASE_URL, null) ?: BuildConfig.BASE_URL
    val tokenUrl: String get() = prefs.getString(PREF_TOKEN_URL, null) ?: BuildConfig.TOKEN_URL

    fun save(geoVisionUrl: String, apiKey: String, tokenUrl: String) {
        prefs.edit {
            putString(PREF_BASE_URL, geoVisionUrl)

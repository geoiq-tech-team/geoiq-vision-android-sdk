...
sealed class GeoVisionEvent {
    ...
    data class LocalTrackSubscribed(val publication: LocalTrackPublication, val participant: LocalParticipant) : GeoVisionEvent()
    ...
    data class ConnectionQualityChanged(val quality: ConnectionQuality, val participant: Participant) : GeoVisionEvent()
    ...
    data class ParticipantAttributesChanged(val participant: Participant, val changedAttributes: Map<String, String>) : GeoVisionEvent()
    ...
    data class TranscriptionReceived(val senderId: String?, val message: String?, val isFinal: Boolean = false) : GeoVisionEvent()
    ...
    data class CustomMessageReceived(val senderId: String?, val message: String?, val topic: String?, val isCritical: Boolean = false) : GeoVisionEvent()
}
